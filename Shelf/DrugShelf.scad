...
slot_internal_width = 60;     // U型槽底部内宽60mm
slot_height = 20;             // U型槽两边高度20mm
total_depth = 60;             // 总体深度60mm（前后方向）
num_slots = 6;                // 6组U型槽
ear_width = 20;               // 耳朵宽度2cm=20mm
ear_height = 3;               // 耳朵高度3mm
screw_hole_diameter = 5.2;    // M4螺丝孔直径(留打印误差空间)
notch_depth_y = 20;           // 单边口Y轴方向深度20mm（约1/3总深度60mm）
notch_width = 10;             // 单边口宽度1cm=10mm
